...
EXPORT_DECL(s32, OSDynLoad_GetAllocator, OSDynLoadAllocFn *outAllocFn, OSDynLoadFreeFn *outFreeFn);
EXPORT_DECL(s32, OSDynLoad_SetAllocator, OSDynLoadAllocFn allocFn, OSDynLoadFreeFn freeFn);
